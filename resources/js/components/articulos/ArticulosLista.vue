<template>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card card-default">
                    ...
                    <button @click="nuevoArticulo()" class="btn btn-primary btn-xs pull-right"><i class="fa fa-plus"></i></button>
                    </div>
         ...
         <div class="modal fade" id="modal-nuevo-articulo">
                <div class="modal-dialog modal-md">
                 <div class="modal-content modal-md center">
                    ...
                    <form v-on:submit="registrarArticulo()" method="post" class="form-horizontal">
        ...
        <!-- /.modal -->
             <!--Inicio Modal de Edicion Participante-->
         <div class="modal fade" id="modal-nuevo-articulo">
                <div class="modal-dialog modal-md">
                 <div class="modal-content modal-md center">
                    <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div>
                                        <label for="codigo">Código</label>
                                        <input type="text" v-model="articuloEditar.codigo" class="form-control" name="codigo" id="" placeholder="Ingresar código">
                                    </div>
                                    <div>
                                        <label for="nombre">Nombre</label>
                                        <input type="text" v-model="articuloEditar.nombre" class="form-control" name="nombre" id="" placeholder="Ingresar nombre">
                                    </div>
                                    <div>
                                        <label for="marca">Marca</label>
                                        <input type="text" v-model="articuloEditar.marca" class="form-control" name="marca" id="" placeholder="Ingresar marca">
                                    </div>
                                    <div>
                                        <label for="modelo">Modelo</label>
                                        <input type="text" v-model="articuloEditar.modelo" class="form-control" name="modelo" id="" placeholder="Ingresar modelo">
                                    </div>
                                </div>
                            </div>
                        </div>
